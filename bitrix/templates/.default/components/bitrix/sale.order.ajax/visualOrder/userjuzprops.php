...
<div class="b_grid_unit-1-2">
	<div class="b_grid_level grid_level_15px">
		<div class="b_grid_unit-1">
			<span class="fs_24px">Контактные данные</span>
	...
	<div class="b_grid_level grid_level_15px">
		<div class="b_grid_unit-1-3 lh_30px">
			<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["NAME"] ?>:<span class="sof-req">*</span>
		</div>
		<div class="b_grid_unit-2-3">
			<input type="text" class="b_input-text input-text_width_240px" maxlength="250" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["FIELD_NAME"]?>">
		</div>
	</div>
	<? // e-mail ?>
	<div class="b_grid_level grid_level_15px">
		<div class="b_grid_unit-1-3 lh_30px">
			<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["NAME"] ?>:<span class="sof-req">*</span>
		</div>
		<div class="b_grid_unit-2-3">
			<input type="text" class="b_input-text input-text_width_240px" maxlength="250" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["FIELD_NAME"]?>">
		</div>
	</div>
	<? // телефон ?>
	<div class="b_grid_level grid_level_15px">
		<div class="b_grid_unit-1-3 lh_30px">
			<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["NAME"] ?>:<span class="sof-req">*</span>
		</div>
		<div class="b_grid_unit-2-3">
			<input type="text" class="b_input-text input-text_width_240px" maxlength="250" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["FIELD_NAME"]?>">
		</div>
	</div>
	<? // местоположение ?>
