...
<?=bitrix_sessid_post()?>
	...
	<div class="margin-bottom_20px margin-top_15px">
		<textarea style="height:150px;padding-bottom:40px;" class="b_textarea ff_helvetica-neue-light textarea_width_267px" placeholder="<?=GetMessage("MFT_MESSAGE")?>"></textarea>
		<div class="ta_right">
