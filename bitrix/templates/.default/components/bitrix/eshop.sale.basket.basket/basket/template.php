<?if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	<div class="b_grid">
		<div class="b_grid_unit-1-2">
			...
			<h3>Заказывая iPhone 5s или iPhone 5с примите во внимание, что доставка заказов начнется с 21 сентября, т.к. с этой даты компания Apple открывает продажу этих телефонов.</h3>
		</div>
		<div class="b_grid_unit-1-2 ta_right">
			<a class="link_007eb4 margin-top_35px float_right display_block" href="/catalog/">Продолжить покупки</a>
		</div>
	</div>
