	...
	<? //if($USER->IsAdmin()){ var_dump($arResult);} ?>
		...
		<? if($arResult["COUPON"]): ?>
			...
			<? /*<div>Ваш купон: <span class="fs_bold"><?=$arResult["COUPON"]?></span></div>*/ ?>
				<div>Купон на скидку активирован. Ваша скидка: 3% на технику, 10% на чехлы и аксессуары.</div>
		<? else: ?>
			<div>
				<div style="float:left; padding:4px 10px 0 0;">
					Код купона: <input type="text" style="height:16px; font-size:14px; line-height:16px; padding:2px 5px; border:1px solid #dedfe0" name="COUPON" value="">
				</div>
