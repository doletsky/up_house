...
<div class="contact-details">
    ...
    <input type="text" placeholder="Ф.И.О.*" required class="form-input form-input-name"  value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["FIELD_NAME"]?>"><br />
    <input type="email" placeholder="e-mail*" required class="form-input form-input-name" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["FIELD_NAME"]?>"><br />
    <input type="tel" placeholder="контактный телефон*" required class="form-input form-input-name" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][3]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][3]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][3]["FIELD_NAME"]?>"><br />
