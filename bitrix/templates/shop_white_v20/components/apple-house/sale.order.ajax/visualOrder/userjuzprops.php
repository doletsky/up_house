...
<div class="contact-details">
    ...
    <input type="text" placeholder="Ф.И.О.*" required class="form-input form-input-name" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][22]["FIELD_NAME"]?>"><br />
    <input type="email" placeholder="e-mail*" required class="form-input form-input-name" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][23]["FIELD_NAME"]?>"><br />
    <input type="tel" placeholder="контактный телефон*" required class="form-input form-input-name" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][24]["FIELD_NAME"]?>"><br />
