...
<div class="col-xs-6">
    <div class="contact-details">
        ...
        <input type="text" placeholder="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["NAME"] ?>*" required class="form-input form-input-name" maxlength="250" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][1]["FIELD_NAME"]?>"><br />
        <input type="email" placeholder="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["NAME"] ?>*" required class="form-input form-input-name" maxlength="250" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["VALUE"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["FIELD_NAME"]?>" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][2]["FIELD_NAME"]?>"><br />
        <input type="tel" placeholder="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][3]["NAME"] ?>*" required class="form-input form-input-name"><br />
    </div>
