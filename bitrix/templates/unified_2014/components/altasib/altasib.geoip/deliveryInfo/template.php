                                    ...
                                    switch($deliveryItem['ID']){
                                        ...
                                        case 13: //'Доставка по Краснодарскому краю':
                                            ...
                                            if($currentHour >= 0 && $currentHour < 12)
                                                $rightPartOfTime = ' <span class="make_bold">Сегодня</span>, '. /*$currentDate .*/' до 16:00. <br /><span class="make_small">При оформлении заказа до 12.00<span>';
elseif($currentHour >= 12 && $currentHour < 17)
                                                $rightPartOfTime = ' <span class="make_bold">Сегодня</span>, '. /*$currentDate .*/' до 20:00. <br /><span class="make_small">При оформлении заказа до 17.00<span>';
                                            elseif($currentHour >= 17 && $currentHour < 19)
                                                $rightPartOfTime = ' <span class="make_bold">Сегодня</span>, '. /*$currentDate .*/' до 24:00. <br /><span class="make_small">При оформлении заказа до 19.00<span>';
                                            elseif($currentHour >= 19 && $currentHour < 24)
                                                $rightPartOfTime = ' <span class="make_bold">Завтра</span>, '. /*date('d.m.Y', strtotime('+1 day', strtotime($currentDate))) .*/' до 12:00. <br /><span class="make_small">При оформлении заказа сегодня до 24.00<span>';
                                        ...
                                        case 5: //'Самовывоз':
                                            ...
                                            if($deliveryItem['CITY_ID'] == 670){
                                                $deliveryDescr = 'г. Москва, Багратионовский проезд, д. 7, к. 2. Деловой центр "Рубин", телефон +7 (495) 966-12-34  <span class="pseudo_link" id="delivery_map_moscow_btn" href="#yandex_map_moscow">посмотреть на карте</span>';
                                                $deliveryDescrAsLink = 'м. Багратионовская';
                                            }
                                            elseif($deliveryItem['CITY_ID'] == 1316){
                                                $deliveryDescr = 'г. Краснодар, ул. Стасова 178. ТК "МедиаПлаза", телефон: +7 (861) 292-29-88, +7 (928) 884-29-88 <span class="pseudo_link" id="delivery_map_krasnodar_btn" href="#yandex_map_krasnodar">посмотреть на карте</span>';
