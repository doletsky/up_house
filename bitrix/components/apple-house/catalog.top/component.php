...
if($this->StartResultCache(false, array($arrFilter, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()))))
{
	...
	************************************/
	...
	while($obElement = $rsElements->GetNextElement())
	{
        ...
        //else
        //    $arItem["BUY_URL"] = htmlspecialcharsbx('/?' . $arParams["ACTION_VARIABLE"]."=BUY&".$arParams["PRODUCT_ID_VARIABLE"]."=".$arItem["ID"], array($arParams["PRODUCT_ID_VARIABLE"], $arParams["ACTION_VARIABLE"]));
