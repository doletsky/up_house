...
$(document).ready(function() {
	...
	$('#modal_preOrder_submit').click(function(e) {
		...
		$.post(
			'/include/tools/preorder_v20.php',
			{
				orderAjax : 'Y',
    ...
    <div class="pop-up pop-up-preorder" id="pop-up-quick-order-form">
        <div class="clearfix pop-up-header">
            <h1 class="pull-left pop-up-title">Предзаказ</h1>
        ...
        <div class="pop-up-form-block clearfix">
            <div class="contact-details">
                <input id="preOrder_name" type="text" placeholder="Ф.И.О.*" required="" class="form-input form-input-name"><br>
                <input id="preOrder_email" type="email" placeholder="e-mail*" required="" class="form-input form-input-name"><br>
                <input id="preOrder_phone" type="tel" placeholder="контактный телефон*"  class="form-input form-input-name">
            </div>
            <div class="contact-details-2">
                <textarea id="preOrder_message" class="form-textarea" placeholder="адрес и комментарий "></textarea>
            </div>
        </div>

        <div class="pop-up-buy clearfix">
            <div class="pop-up-buy-text pull-left">
                Как только товар появится на складе, менеджер нашего магазина свяжется с Вами для уточнения заказа и условий доставки.
            </div>
            <div class="pop-up-buy-button pull-left">
                <a id="modal_preOrder_submit" href="#" class="button-bg">заказать</a>
            </div>
        </div>
